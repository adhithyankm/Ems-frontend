...
import {  editUser, getUsers } from '../services/allApi';
...
function Edit() {
  ...
  // to get the data to the input field
  ...
  const getSingleUser = async () => {
    ...
    // assigning the values in the existingUser to normal inputs 

    setNormalInputs(exsistingUser)
     setStatus(exsistingUser.status)
     setexistingImg(exsistingUser.profile)
